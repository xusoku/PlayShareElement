...
/**
 * Created by xushengfu on 2019/4/28.
 */

public class PlayerViewNew extends FrameLayout {
    ...
    private final PlayerViewNew.ComponentListener componentListener;
    ...
    public PlayerViewNew(Context context) {
        this(context, null);
    }

    public PlayerViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlayerViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        componentListener = new PlayerViewNew.ComponentListener();
    ...
    public static void switchTargetView(
            ...
            @Nullable PlayerViewNew oldPlayerView,
            @Nullable PlayerViewNew newPlayerView) {
     ...
     * {@link #switchTargetView(Player, PlayerViewNew, PlayerViewNew)} rather than this method. If you do
